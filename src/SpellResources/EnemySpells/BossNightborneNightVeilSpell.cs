...
public partial class BossNightborneNightVeilSpell : SpellResource
{
	...
	{
		Name        = "Night Veil";
		Description = $"Wraps the target in a suffocating veil of shadow, dealing {DamagePerSecond} damage per second for {Duration} seconds. Dispellable.";
	...
	public override void Apply(SpellContext ctx)
	{
		...
		{
			target.ApplyEffect(new DamageOverTimeEffect(DamagePerSecond, Duration, 1f, isDispellable: true)
			{
				EffectId            = "NightVeil",
				AbilityName         = Name,
